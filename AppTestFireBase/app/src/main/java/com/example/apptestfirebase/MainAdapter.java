...
public class MainAdapter extends FirebaseRecyclerAdapter<MainModel, MainAdapter.myViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel model) {
        ...
        holder.dir.setText(model.getEmail());
        holder.price.setText(model.getCourse());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TextView name = (TextView) viewDialog.findViewById(R.id.txtView);
                TextView dir = (TextView) viewDialog.findViewById(R.id.txtDicription);
                TextView price = (TextView) viewDialog.findViewById(R.id.priceCart);
                CircleImageView imgDetail = (CircleImageView) viewDialog.findViewById(R.id.img_detail);

                name.setText(model.getName());
                dir.setText(model.getCourse());
                price.setText(model.getEmail());
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText dir = (EditText) viewDialog.findViewById(R.id.txtDir);
                EditText price = (EditText) viewDialog.findViewById(R.id.txtPrice);
    ...
    class myViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView name, dir, price;
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            dir = (TextView) itemView.findViewById(R.id.priceBurger);
            price = (TextView) itemView.findViewById(R.id.dir_burger);
